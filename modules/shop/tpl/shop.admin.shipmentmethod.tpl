...
<table class="cells">
    <tr>
        ...
        <td class="coltop">{PHP.L.shop.shipment_title}</td>
        <td class="coltop">{PHP.L.shop.shipment_description}</td>
        <td class="coltop">{PHP.L.Groups}</td>
        <td class="coltop">{PHP.L.shop.shipment_plugin}</td>
...
<!-- IF {LIST_SHIP_PLUG_INSTALLED} -->
<input type="button" onclick="window.location='{PHP|cot_url('admin', 'm=shop&n=shipmentmethod&a=edit')}'" value="{PHP.L.Add}" />
<!-- ENDIF -->
</form>
...
<!-- BEGIN: EDIT -->
    ...
    <!-- BEGIN: FORM -->
    <form method="post" action="{PHP|cot_url('admin', 'm=shop&n=shipmentmethod&a=edit')}">
        <input type="hidden" name="rid" value="{FORM_ID}" />
        <input type="hidden" name="act" value="save" />
        <h3>{PHP.L.shop.shipment_method}</h3>
        <table class="cells">
            <tr>
                <td>{PHP.L.shop.shipment_title}:</td>
                <td>{FORM_TITLE}</td>
            </tr>
            <tr>
                <td>{PHP.L.shop.shipment_description}:</td>
                <td>{FORM_DESC}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>{PHP.L.shop.shipment_plugin}:</td>
        ...
        <!-- IF !{FORM_ID} -->
        <p class="strong">{PHP.L.shop.select_shipping_method}</p>
        <!-- ENDIF -->
